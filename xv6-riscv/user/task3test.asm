...
void print_perf(struct perf *performance) {
  ...
  10:	8bc58593          	addi	a1,a1,-1860 # 8c8 <malloc+0xe8>
  14:	4505                	li	a0,1
  16:	00000097          	auipc	ra,0x0
  1a:	6de080e7          	jalr	1758(ra) # 6f4 <fprintf>
    fprintf(1, "\tctime: %d\n", performance->ctime);
  1e:	4090                	lw	a2,0(s1)
  20:	00001597          	auipc	a1,0x1
  24:	8b058593          	addi	a1,a1,-1872 # 8d0 <malloc+0xf0>
  28:	4505                	li	a0,1
  2a:	00000097          	auipc	ra,0x0
  2e:	6ca080e7          	jalr	1738(ra) # 6f4 <fprintf>
    fprintf(1, "\tttime: %d\n", performance->ttime);
  32:	40d0                	lw	a2,4(s1)
  34:	00001597          	auipc	a1,0x1
  38:	8ac58593          	addi	a1,a1,-1876 # 8e0 <malloc+0x100>
  3c:	4505                	li	a0,1
  3e:	00000097          	auipc	ra,0x0
  42:	6b6080e7          	jalr	1718(ra) # 6f4 <fprintf>
    fprintf(1, "\tstime: %d\n", performance->stime);
  46:	4490                	lw	a2,8(s1)
  48:	00001597          	auipc	a1,0x1
  4c:	8a858593          	addi	a1,a1,-1880 # 8f0 <malloc+0x110>
  50:	4505                	li	a0,1
  ...
  60:	8a458593          	addi	a1,a1,-1884 # 900 <malloc+0x120>
  64:	4505                	li	a0,1
  66:	00000097          	auipc	ra,0x0
  6a:	68e080e7          	jalr	1678(ra) # 6f4 <fprintf>
    fprintf(1, "\trutime: %d\n", performance->rutime);
  6e:	4890                	lw	a2,16(s1)
  70:	00001597          	auipc	a1,0x1
  74:	8a058593          	addi	a1,a1,-1888 # 910 <malloc+0x130>
  78:	4505                	li	a0,1
  7a:	00000097          	auipc	ra,0x0
  7e:	67a080e7          	jalr	1658(ra) # 6f4 <fprintf>
    fprintf(1, "\tavarage_btime: %d\n", performance->bursttime);
  82:	48d0                	lw	a2,20(s1)
  84:	00001597          	auipc	a1,0x1
  88:	89c58593          	addi	a1,a1,-1892 # 920 <malloc+0x140>
  8c:	4505                	li	a0,1
  8e:	00000097          	auipc	ra,0x0
  92:	666080e7          	jalr	1638(ra) # 6f4 <fprintf>
    fprintf(1, "\n\tTurnaround time: %d\n", (performance->ttime - performance->ctime));
  96:	40d0                	lw	a2,4(s1)
  98:	409c                	lw	a5,0(s1)
  9a:	9e1d                	subw	a2,a2,a5
  9c:	00001597          	auipc	a1,0x1
  a0:	89c58593          	addi	a1,a1,-1892 # 938 <malloc+0x158>
  a4:	4505                	li	a0,1
  a6:	00000097          	auipc	ra,0x0
  aa:	64e080e7          	jalr	1614(ra) # 6f4 <fprintf>
}
  ae:	60e2                	ld	ra,24(sp)
  b0:	6442                	ld	s0,16(sp)
  b2:	64a2                	ld	s1,8(sp)
...
int main(int argc, char** argv){
  ...
  c6:	380080e7          	jalr	896(ra) # 442 <set_priority>
  ca:	85aa                	mv	a1,a0
	printf("father ans=%d\n",ans);
  cc:	00001517          	auipc	a0,0x1
  d0:	88450513          	addi	a0,a0,-1916 # 950 <malloc+0x170>
  d4:	00000097          	auipc	ra,0x0
  d8:	64e080e7          	jalr	1614(ra) # 722 <printf>
	int pid1=fork();
  dc:	00000097          	auipc	ra,0x0
  e0:	2ae080e7          	jalr	686(ra) # 38a <fork>
	int status;
	if(pid1>0){
  e4:	00a05d63          	blez	a0,fe <main+0x46>
		wait(&status);
  e8:	fec40513          	addi	a0,s0,-20
  ec:	00000097          	auipc	ra,0x0
  f0:	2ae080e7          	jalr	686(ra) # 39a <wait>
 ...
 104:	342080e7          	jalr	834(ra) # 442 <set_priority>
 108:	85aa                	mv	a1,a0
		printf("son ans=%d\n",ans2);
 10a:	00001517          	auipc	a0,0x1
 10e:	85650513          	addi	a0,a0,-1962 # 960 <malloc+0x180>
 112:	00000097          	auipc	ra,0x0
 116:	610080e7          	jalr	1552(ra) # 722 <printf>
		exit(0);
 11a:	4501                	li	a0,0
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 55e:	41eb8b93          	addi	s7,s7,1054 # 978 <digits>
 ...
 69e:	2d690913          	addi	s2,s2,726 # 970 <malloc+0x190>
        while(*s != 0){
 ...
 794:	00e6ea63          	bltu	a3,a4,7a8 <free+0x50>
{
 ...
 7d6:	1af73f23          	sd	a5,446(a4) # 990 <freep>
}
 7da:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 808:	18c53503          	ld	a0,396(a0) # 990 <freep>
 ...
 830:	16490913          	addi	s2,s2,356 # 990 <freep>
  if(p == (char*)-1)
 834:	5afd                	li	s5,-1
 836:	a895                	j	8aa <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 838:	00000797          	auipc	a5,0x0
 83c:	16078793          	addi	a5,a5,352 # 998 <base>
 840:	00000717          	auipc	a4,0x0
 844:	14f73823          	sd	a5,336(a4) # 990 <freep>
 848:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 86c:	12a73423          	sd	a0,296(a4) # 990 <freep>
      return (void*)(p + 1);
 ...
 898:	ec4080e7          	jalr	-316(ra) # 758 <free>
  return freep;
 ...
 8ba:	b64080e7          	jalr	-1180(ra) # 41a <sbrk>
  if(p == (char*)-1)
