...
main(void)
{
  ...
  1c:	3a2080e7          	jalr	930(ra) # 3ba <open>
  ...
  2a:	3cc080e7          	jalr	972(ra) # 3f2 <dup>
  dup(0);  // stderr
  2e:	4501                	li	a0,0
  30:	00000097          	auipc	ra,0x0
  34:	3c2080e7          	jalr	962(ra) # 3f2 <dup>

  for(;;){
    printf("init: starting sh\n");
  38:	00001997          	auipc	s3,0x1
  3c:	86898993          	addi	s3,s3,-1944 # 8a0 <malloc+0xf0>
    pid = fork();
    printf("forked in init.c\n");
  40:	00001917          	auipc	s2,0x1
  44:	87890913          	addi	s2,s2,-1928 # 8b8 <malloc+0x108>
    printf("init: starting sh\n");
  48:	854e                	mv	a0,s3
  4a:	00000097          	auipc	ra,0x0
  4e:	6a8080e7          	jalr	1704(ra) # 6f2 <printf>
    pid = fork();
  52:	00000097          	auipc	ra,0x0
  56:	320080e7          	jalr	800(ra) # 372 <fork>
  5a:	84aa                	mv	s1,a0
    printf("forked in init.c\n");
  5c:	854a                	mv	a0,s2
  5e:	00000097          	auipc	ra,0x0
  62:	694080e7          	jalr	1684(ra) # 6f2 <printf>
    if(pid < 0){
  66:	0404cd63          	bltz	s1,c0 <main+0xc0>
      printf("init: fork failed\n");
      exit(1);
    }
    if(pid == 0){
  6a:	c8a5                	beqz	s1,da <main+0xda>
    }
  ...
  82:	88a50513          	addi	a0,a0,-1910 # 908 <malloc+0x158>
  ...
  a0:	7fc50513          	addi	a0,a0,2044 # 898 <malloc+0xe8>
  a4:	00000097          	auipc	ra,0x0
  a8:	31e080e7          	jalr	798(ra) # 3c2 <mknod>
    open("console", O_RDWR);
  ac:	4589                	li	a1,2
  ae:	00000517          	auipc	a0,0x0
  b2:	7ea50513          	addi	a0,a0,2026 # 898 <malloc+0xe8>
  b6:	00000097          	auipc	ra,0x0
  ba:	304080e7          	jalr	772(ra) # 3ba <open>
  be:	b79d                	j	24 <main+0x24>
      printf("init: fork failed\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	81050513          	addi	a0,a0,-2032 # 8d0 <malloc+0x120>
  ...
  de:	86e58593          	addi	a1,a1,-1938 # 948 <argv>
  e2:	00001517          	auipc	a0,0x1
  e6:	80650513          	addi	a0,a0,-2042 # 8e8 <malloc+0x138>
  ea:	00000097          	auipc	ra,0x0
  ee:	2c8080e7          	jalr	712(ra) # 3b2 <exec>
      printf("init: exec sh failed\n");
  f2:	00000517          	auipc	a0,0x0
  f6:	7fe50513          	addi	a0,a0,2046 # 8f0 <malloc+0x140>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 462:	4d250513          	addi	a0,a0,1234 # 930 <digits>
 466:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 66e:	2be90913          	addi	s2,s2,702 # 928 <malloc+0x178>
        while(*s != 0){
...
free(void *ap)
{
 ...
 736:	2267b783          	ld	a5,550(a5) # 958 <freep>
...
malloc(uint nbytes)
{
 ...
 800:	15c90913          	addi	s2,s2,348 # 958 <freep>
  if(p == (char*)-1)
 804:	5afd                	li	s5,-1
 806:	a895                	j	87a <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 808:	00000797          	auipc	a5,0x0
 80c:	15878793          	addi	a5,a5,344 # 960 <base>
