...
main(int argc, char **argv)
{
  ...
  4e:	7de58593          	addi	a1,a1,2014 # 828 <malloc+0xe6>
  52:	4509                	li	a0,2
  54:	00000097          	auipc	ra,0x0
  58:	602080e7          	jalr	1538(ra) # 656 <fprintf>
    exit(1);
  5c:	4505                	li	a0,1
...
putc(int fd, char c)
{
 ...
 3c2:	f36080e7          	jalr	-202(ra) # 2f4 <write>
}
...
free(void *ap)
{
 ...
 6c8:	19c7b783          	ld	a5,412(a5) # 860 <freep>
 ...
 6f6:	00e6ea63          	bltu	a3,a4,70a <free+0x50>
{
 ...
 738:	12f73623          	sd	a5,300(a4) # 860 <freep>
}
 73c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 76a:	0fa53503          	ld	a0,250(a0) # 860 <freep>
 ...
 792:	0d290913          	addi	s2,s2,210 # 860 <freep>
  if(p == (char*)-1)
 796:	5afd                	li	s5,-1
 ...
 7a6:	0af73f23          	sd	a5,190(a4) # 860 <freep>
 7aa:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7ce:	08a73b23          	sd	a0,150(a4) # 860 <freep>
      return (void*)(p + 1);
 ...
 81c:	b44080e7          	jalr	-1212(ra) # 35c <sbrk>
  if(p == (char*)-1)
