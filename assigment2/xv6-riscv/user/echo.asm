...
main(int argc, char *argv[])
{
  ...
  2e:	9cea0a13          	addi	s4,s4,-1586 # 9f8 <csem_free+0x68>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	a2058593          	addi	a1,a1,-1504 # a88 <digits+0x80>
  70:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 434:	5d850513          	addi	a0,a0,1496 # a08 <digits>
 438:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 500:	50cb8b93          	addi	s7,s7,1292 # a08 <digits>
 ...
 640:	3c490913          	addi	s2,s2,964 # a00 <csem_free+0x70>
        while(*s != 0){
...
free(void *ap)
{
 ...
 708:	3bc7b783          	ld	a5,956(a5) # ac0 <freep>
 ...
 736:	00e6ea63          	bltu	a3,a4,74a <free+0x50>
{
 ...
 778:	34f73623          	sd	a5,844(a4) # ac0 <freep>
}
 77c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7aa:	31a53503          	ld	a0,794(a0) # ac0 <freep>
 ...
 7d2:	2f290913          	addi	s2,s2,754 # ac0 <freep>
  if(p == (char*)-1)
 7d6:	5afd                	li	s5,-1
 7d8:	a895                	j	84c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7da:	00000797          	auipc	a5,0x0
 7de:	2ee78793          	addi	a5,a5,750 # ac8 <base>
 7e2:	00000717          	auipc	a4,0x0
 7e6:	2cf73f23          	sd	a5,734(a4) # ac0 <freep>
 7ea:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 80e:	2aa73b23          	sd	a0,694(a4) # ac0 <freep>
      return (void*)(p + 1);
...
csem_down(struct counting_semaphore *sem){
 ...
 870:	1000                	addi	s0,sp,32
    if(!sem){
 872:	cd29                	beqz	a0,8cc <csem_down+0x64>
 874:	84aa                	mv	s1,a0
 ...
 87c:	b62080e7          	jalr	-1182(ra) # 3da <bsem_down>
    sem->waiting++;
 880:	44dc                	lw	a5,12(s1)
 882:	2785                	addiw	a5,a5,1
 884:	c4dc                	sw	a5,12(s1)
    bsem_up(sem->S1_desc);
 886:	4088                	lw	a0,0(s1)
 888:	00000097          	auipc	ra,0x0
 88c:	b5a080e7          	jalr	-1190(ra) # 3e2 <bsem_up>

    bsem_down(sem->S2_desc);
 890:	40c8                	lw	a0,4(s1)
 892:	00000097          	auipc	ra,0x0
 896:	b48080e7          	jalr	-1208(ra) # 3da <bsem_down>
    bsem_down(sem->S1_desc);
 89a:	4088                	lw	a0,0(s1)
 89c:	00000097          	auipc	ra,0x0
 8a0:	b3e080e7          	jalr	-1218(ra) # 3da <bsem_down>
    sem->waiting--;
 8a4:	44dc                	lw	a5,12(s1)
 8a6:	37fd                	addiw	a5,a5,-1
 8a8:	c4dc                	sw	a5,12(s1)
    sem->value--;
 8aa:	449c                	lw	a5,8(s1)
 ...
 8b2:	c49c                	sw	a5,8(s1)
    if(sem->value > 0)
 8b4:	02e04563          	bgtz	a4,8de <csem_down+0x76>
        bsem_up(sem->S2_desc);
    bsem_up(sem->S1_desc);
 8b8:	4088                	lw	a0,0(s1)
 8ba:	00000097          	auipc	ra,0x0
 8be:	b28080e7          	jalr	-1240(ra) # 3e2 <bsem_up>

}
 8c2:	60e2                	ld	ra,24(sp)
 8c4:	6442                	ld	s0,16(sp)
 8c6:	64a2                	ld	s1,8(sp)
 8c8:	6105                	addi	sp,sp,32
 8ca:	8082                	ret
        printf("invalid sem pointer in csem_down\n");
 8cc:	00000517          	auipc	a0,0x0
 8d0:	15450513          	addi	a0,a0,340 # a20 <digits+0x18>
 8d4:	00000097          	auipc	ra,0x0
 8d8:	df0080e7          	jalr	-528(ra) # 6c4 <printf>
        return;
 8dc:	b7dd                	j	8c2 <csem_down+0x5a>
        bsem_up(sem->S2_desc);
 8de:	40c8                	lw	a0,4(s1)
 8e0:	00000097          	auipc	ra,0x0
 8e4:	b02080e7          	jalr	-1278(ra) # 3e2 <bsem_up>
 8e8:	bfc1                	j	8b8 <csem_down+0x50>

00000000000008ea <csem_up>:
...
csem_up(struct counting_semaphore *sem){
 ...
 8f2:	1000                	addi	s0,sp,32
    if(!sem){
 8f4:	c90d                	beqz	a0,926 <csem_up+0x3c>
 8f6:	84aa                	mv	s1,a0
 ...
 8fe:	ae0080e7          	jalr	-1312(ra) # 3da <bsem_down>
    sem->value++;
 902:	449c                	lw	a5,8(s1)
 ...
 90a:	c49c                	sw	a5,8(s1)
    if(sem->value == 1)
 90c:	4785                	li	a5,1
 90e:	02f70563          	beq	a4,a5,938 <csem_up+0x4e>
        bsem_up(sem->S2_desc);
    bsem_up(sem->S1_desc);
 912:	4088                	lw	a0,0(s1)
 914:	00000097          	auipc	ra,0x0
 918:	ace080e7          	jalr	-1330(ra) # 3e2 <bsem_up>
}
 ...
 92a:	12250513          	addi	a0,a0,290 # a48 <digits+0x40>
 92e:	00000097          	auipc	ra,0x0
 932:	d96080e7          	jalr	-618(ra) # 6c4 <printf>
        return;
 936:	b7dd                	j	91c <csem_up+0x32>
        bsem_up(sem->S2_desc);
 938:	40c8                	lw	a0,4(s1)
 93a:	00000097          	auipc	ra,0x0
 93e:	aa8080e7          	jalr	-1368(ra) # 3e2 <bsem_up>
 942:	bfc1                	j	912 <csem_up+0x28>

0000000000000944 <csem_alloc>:
...
csem_alloc(struct counting_semaphore *sem, int initial_value){
 ...
 958:	a76080e7          	jalr	-1418(ra) # 3ca <bsem_alloc>
 95c:	c088                	sw	a0,0(s1)
    sem->S2_desc = bsem_alloc();
 95e:	00000097          	auipc	ra,0x0
 962:	a6c080e7          	jalr	-1428(ra) # 3ca <bsem_alloc>
 966:	c0c8                	sw	a0,4(s1)
    if(sem->S1_desc <0 || sem->S2_desc < 0)
 968:	409c                	lw	a5,0(s1)
 96a:	0007cf63          	bltz	a5,988 <csem_alloc+0x44>
 96e:	00054f63          	bltz	a0,98c <csem_alloc+0x48>
        return -1;
    sem->value = initial_value;
 972:	0124a423          	sw	s2,8(s1)
    sem->waiting = 0;
 976:	0004a623          	sw	zero,12(s1)
 ...
 986:	8082                	ret
        return -1;
 988:	557d                	li	a0,-1
 98a:	bfcd                	j	97c <csem_alloc+0x38>
 98c:	557d                	li	a0,-1
 98e:	b7fd                	j	97c <csem_alloc+0x38>

0000000000000990 <csem_free>:
void            
csem_free(struct counting_semaphore *sem){
 ...
 998:	1000                	addi	s0,sp,32
    if(!sem){
 99a:	c905                	beqz	a0,9ca <csem_free+0x3a>
 99c:	84aa                	mv	s1,a0
 ...
 9a4:	a3a080e7          	jalr	-1478(ra) # 3da <bsem_down>

    if(sem->waiting!=0){
 9a8:	44dc                	lw	a5,12(s1)
 9aa:	eb8d                	bnez	a5,9dc <csem_free+0x4c>
 ...
 9b2:	a24080e7          	jalr	-1500(ra) # 3d2 <bsem_free>
    bsem_free(sem->S2_desc);
 9b6:	40c8                	lw	a0,4(s1)
 9b8:	00000097          	auipc	ra,0x0
 9bc:	a1a080e7          	jalr	-1510(ra) # 3d2 <bsem_free>
 ...
 9ce:	09e50513          	addi	a0,a0,158 # a68 <digits+0x60>
 9d2:	00000097          	auipc	ra,0x0
 9d6:	cf2080e7          	jalr	-782(ra) # 6c4 <printf>
        return;
 9da:	b7dd                	j	9c0 <csem_free+0x30>
        printf("csem_free: cant free while proc waiting\n");
 9dc:	00000517          	auipc	a0,0x0
 9e0:	0b450513          	addi	a0,a0,180 # a90 <digits+0x88>
 9e4:	00000097          	auipc	ra,0x0
 9e8:	ce0080e7          	jalr	-800(ra) # 6c4 <printf>
        bsem_up(sem->S1_desc);
 9ec:	4088                	lw	a0,0(s1)
 9ee:	00000097          	auipc	ra,0x0
 9f2:	9f4080e7          	jalr	-1548(ra) # 3e2 <bsem_up>
        return;
 9f6:	b7e9                	j	9c0 <csem_free+0x30>
