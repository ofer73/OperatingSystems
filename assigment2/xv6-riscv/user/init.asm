...
main(void)
{
  ...
  12:	a6250513          	addi	a0,a0,-1438 # a70 <csem_free+0x6c>
  ...
  3a:	a4290913          	addi	s2,s2,-1470 # a78 <csem_free+0x74>
  3e:	854a                	mv	a0,s2
  ...
  6e:	a5e50513          	addi	a0,a0,-1442 # ac8 <csem_free+0xc4>
  ...
  8c:	9e850513          	addi	a0,a0,-1560 # a70 <csem_free+0x6c>
  90:	00000097          	auipc	ra,0x0
  94:	31e080e7          	jalr	798(ra) # 3ae <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	9d650513          	addi	a0,a0,-1578 # a70 <csem_free+0x6c>
  a2:	00000097          	auipc	ra,0x0
  a6:	304080e7          	jalr	772(ra) # 3a6 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	9e450513          	addi	a0,a0,-1564 # a90 <csem_free+0x8c>
  ...
  ca:	ae258593          	addi	a1,a1,-1310 # ba8 <argv>
  ce:	00001517          	auipc	a0,0x1
  d2:	9da50513          	addi	a0,a0,-1574 # aa8 <csem_free+0xa4>
  d6:	00000097          	auipc	ra,0x0
  da:	2c8080e7          	jalr	712(ra) # 39e <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	9d250513          	addi	a0,a0,-1582 # ab0 <csem_free+0xac>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a8:	64c50513          	addi	a0,a0,1612 # af0 <digits>
 4ac:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 574:	580b8b93          	addi	s7,s7,1408 # af0 <digits>
 ...
 6b4:	43890913          	addi	s2,s2,1080 # ae8 <csem_free+0xe4>
        while(*s != 0){
...
free(void *ap)
{
 ...
 77c:	4407b783          	ld	a5,1088(a5) # bb8 <freep>
 ...
 7aa:	00e6ea63          	bltu	a3,a4,7be <free+0x50>
{
 ...
 7ec:	3cf73823          	sd	a5,976(a4) # bb8 <freep>
}
 7f0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 81e:	39e53503          	ld	a0,926(a0) # bb8 <freep>
 ...
 846:	37690913          	addi	s2,s2,886 # bb8 <freep>
  if(p == (char*)-1)
 84a:	5afd                	li	s5,-1
 84c:	a895                	j	8c0 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 84e:	00000797          	auipc	a5,0x0
 852:	37278793          	addi	a5,a5,882 # bc0 <base>
 856:	00000717          	auipc	a4,0x0
 85a:	36f73123          	sd	a5,866(a4) # bb8 <freep>
 85e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 882:	32a73d23          	sd	a0,826(a4) # bb8 <freep>
      return (void*)(p + 1);
...
csem_down(struct counting_semaphore *sem){
 ...
 8e4:	1000                	addi	s0,sp,32
    if(!sem){
 8e6:	cd29                	beqz	a0,940 <csem_down+0x64>
 8e8:	84aa                	mv	s1,a0
 ...
 8f0:	b62080e7          	jalr	-1182(ra) # 44e <bsem_down>
    sem->waiting++;
 8f4:	44dc                	lw	a5,12(s1)
 8f6:	2785                	addiw	a5,a5,1
 8f8:	c4dc                	sw	a5,12(s1)
    bsem_up(sem->S1_desc);
 8fa:	4088                	lw	a0,0(s1)
 8fc:	00000097          	auipc	ra,0x0
 900:	b5a080e7          	jalr	-1190(ra) # 456 <bsem_up>

    bsem_down(sem->S2_desc);
 904:	40c8                	lw	a0,4(s1)
 906:	00000097          	auipc	ra,0x0
 90a:	b48080e7          	jalr	-1208(ra) # 44e <bsem_down>
    bsem_down(sem->S1_desc);
 90e:	4088                	lw	a0,0(s1)
 910:	00000097          	auipc	ra,0x0
 914:	b3e080e7          	jalr	-1218(ra) # 44e <bsem_down>
    sem->waiting--;
 918:	44dc                	lw	a5,12(s1)
 91a:	37fd                	addiw	a5,a5,-1
 91c:	c4dc                	sw	a5,12(s1)
    sem->value--;
 91e:	449c                	lw	a5,8(s1)
 920:	37fd                	addiw	a5,a5,-1
 922:	0007871b          	sext.w	a4,a5
 926:	c49c                	sw	a5,8(s1)
    if(sem->value > 0)
 928:	02e04563          	bgtz	a4,952 <csem_down+0x76>
        bsem_up(sem->S2_desc);
    bsem_up(sem->S1_desc);
 92c:	4088                	lw	a0,0(s1)
 92e:	00000097          	auipc	ra,0x0
 932:	b28080e7          	jalr	-1240(ra) # 456 <bsem_up>
 ...
 944:	1c850513          	addi	a0,a0,456 # b08 <digits+0x18>
 948:	00000097          	auipc	ra,0x0
 94c:	df0080e7          	jalr	-528(ra) # 738 <printf>
        return;
 950:	b7dd                	j	936 <csem_down+0x5a>
        bsem_up(sem->S2_desc);
 952:	40c8                	lw	a0,4(s1)
 954:	00000097          	auipc	ra,0x0
 958:	b02080e7          	jalr	-1278(ra) # 456 <bsem_up>
 95c:	bfc1                	j	92c <csem_down+0x50>

000000000000095e <csem_up>:
...
csem_up(struct counting_semaphore *sem){
 ...
 966:	1000                	addi	s0,sp,32
    if(!sem){
 968:	c90d                	beqz	a0,99a <csem_up+0x3c>
 96a:	84aa                	mv	s1,a0
 ...
 972:	ae0080e7          	jalr	-1312(ra) # 44e <bsem_down>
    sem->value++;
 976:	449c                	lw	a5,8(s1)
 ...
 97e:	c49c                	sw	a5,8(s1)
    if(sem->value == 1)
 980:	4785                	li	a5,1
 982:	02f70563          	beq	a4,a5,9ac <csem_up+0x4e>
        bsem_up(sem->S2_desc);
    bsem_up(sem->S1_desc);
 986:	4088                	lw	a0,0(s1)
 988:	00000097          	auipc	ra,0x0
 98c:	ace080e7          	jalr	-1330(ra) # 456 <bsem_up>
}
 ...
 99e:	19650513          	addi	a0,a0,406 # b30 <digits+0x40>
 9a2:	00000097          	auipc	ra,0x0
 9a6:	d96080e7          	jalr	-618(ra) # 738 <printf>
        return;
 9aa:	b7dd                	j	990 <csem_up+0x32>
        bsem_up(sem->S2_desc);
 9ac:	40c8                	lw	a0,4(s1)
 9ae:	00000097          	auipc	ra,0x0
 9b2:	aa8080e7          	jalr	-1368(ra) # 456 <bsem_up>
 9b6:	bfc1                	j	986 <csem_up+0x28>

00000000000009b8 <csem_alloc>:
...
csem_alloc(struct counting_semaphore *sem, int initial_value){
 ...
 9cc:	a76080e7          	jalr	-1418(ra) # 43e <bsem_alloc>
 9d0:	c088                	sw	a0,0(s1)
    sem->S2_desc = bsem_alloc();
 9d2:	00000097          	auipc	ra,0x0
 9d6:	a6c080e7          	jalr	-1428(ra) # 43e <bsem_alloc>
 9da:	c0c8                	sw	a0,4(s1)
    if(sem->S1_desc <0 || sem->S2_desc < 0)
 9dc:	409c                	lw	a5,0(s1)
 9de:	0007cf63          	bltz	a5,9fc <csem_alloc+0x44>
 9e2:	00054f63          	bltz	a0,a00 <csem_alloc+0x48>
        return -1;
    sem->value = initial_value;
 9e6:	0124a423          	sw	s2,8(s1)
    sem->waiting = 0;
 9ea:	0004a623          	sw	zero,12(s1)
 ...
 9fa:	8082                	ret
        return -1;
 9fc:	557d                	li	a0,-1
 9fe:	bfcd                	j	9f0 <csem_alloc+0x38>
 a00:	557d                	li	a0,-1
 a02:	b7fd                	j	9f0 <csem_alloc+0x38>

0000000000000a04 <csem_free>:
void            
csem_free(struct counting_semaphore *sem){
 ...
 a0c:	1000                	addi	s0,sp,32
    if(!sem){
 a0e:	c905                	beqz	a0,a3e <csem_free+0x3a>
 a10:	84aa                	mv	s1,a0
 ...
 a18:	a3a080e7          	jalr	-1478(ra) # 44e <bsem_down>

    if(sem->waiting!=0){
 a1c:	44dc                	lw	a5,12(s1)
 a1e:	eb8d                	bnez	a5,a50 <csem_free+0x4c>
 ...
 a26:	a24080e7          	jalr	-1500(ra) # 446 <bsem_free>
    bsem_free(sem->S2_desc);
 a2a:	40c8                	lw	a0,4(s1)
 a2c:	00000097          	auipc	ra,0x0
 a30:	a1a080e7          	jalr	-1510(ra) # 446 <bsem_free>
 ...
 a42:	11250513          	addi	a0,a0,274 # b50 <digits+0x60>
 a46:	00000097          	auipc	ra,0x0
 a4a:	cf2080e7          	jalr	-782(ra) # 738 <printf>
        return;
 a4e:	b7dd                	j	a34 <csem_free+0x30>
        printf("csem_free: cant free while proc waiting\n");
 a50:	00000517          	auipc	a0,0x0
 a54:	12850513          	addi	a0,a0,296 # b78 <digits+0x88>
 a58:	00000097          	auipc	ra,0x0
 a5c:	ce0080e7          	jalr	-800(ra) # 738 <printf>
        bsem_up(sem->S1_desc);
 a60:	4088                	lw	a0,0(s1)
 a62:	00000097          	auipc	ra,0x0
 a66:	9f4080e7          	jalr	-1548(ra) # 456 <bsem_up>
        return;
 a6a:	b7e9                	j	a34 <csem_free+0x30>
